<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="Fınal_OLMS.adminauthormanagement" %>
            ...
            <div class="col-md-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!--kutu içi resim ve badge'li yazar detayları yazısı -->
                        <div class="row">
                            <div class="col">
                                <center>
                        ...
                        <div class="row">
                         ...
                         <!--resim ve badge'li yazar detayları yazısı sonu-->
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <%--     <asp:Button class="btn btn-warning" ID="Button1" runat="server" Text="Git" OnClick="Button1_Click" /> --%>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!--yazar listesi gridview table sonu-->
