    ...
    public partial class adminpublishermanagement : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (checkIfPublisherExists())
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                    "swal('Bu kimliğine sahip Yayıncı Zaten Var!', 'başka bir kimlik eklemeyi deneyin' ,'warning')", true);
            }
            else
            {
                addNewPublisher();
        ...
        void getPublisherByID()
        {
            try
            {
                ...
                else
                {
                    ...
                    ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                     "swal('Geçersiz Yayıncı Kimliği', 'başka bir kimlik deneyin' ,'warning')", true);
                }
        ...
        void deletePublisher()
        {
            try
            {
                ...
                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                    "swal('Yayıncı Başarıyla Silindi','Devam etmek için butona tıklayınız', 'success')", true);
                clearForm();
                GridView1.DataBind(); //veri kaynağına tekrar bağlar ve taze veriyi almamızı sağlar bu sayede tablo hep güncellenecek
            }
        ...
        void updatePublisher()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@publisher_name", TextBox2.Text.Trim());  //parametreleri ayrı ayrı ekledik
